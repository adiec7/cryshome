...
class MyInfoForm extends React.Component {
  yearOfBirth = ['Select', '2014', '2013', '2012', '2011', '2010'];
  propertyType = ['Property Type', 'House', 'Apartment', 'Unit'];
  bedProperty = ['Beds', 'Studio', '1 Bed', '2 Beds'];
  ownOrRent = ['Own or Rent', 'Owner', 'Investor'];
  render() {
    return (
