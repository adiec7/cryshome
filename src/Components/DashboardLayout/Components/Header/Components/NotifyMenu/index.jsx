  ...
  render() {
    return (
      ...
      >
        <a
          href="#"
          className="headerNotify dropdown-toggle"
        ...
        <div className="dropdown-menu pull-right notifyMenu" role="menu">
          <div className="notifyHeader">
            ...
            <a href="#" className="notifySettings">
              <Icon name="cog" />
            </a>
          ...
          <ul className="notifyList">
            <li onMouseOver={this.infoHover}>
              <a href="#">
                ...
                />
                <div
                  className={`pulse border-grey ${
                    this.state.infoHover ? "pulsate" : ""
                  }`}
                />
